# Generated by Django 3.0.8 on 2020-07-14 21:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorited_by', models.ManyToManyField(blank=True, related_name='favorite_question', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('favorited_by', models.ManyToManyField(blank=True, related_name='favorite_answer', to=settings.AUTH_USER_MODEL)),
